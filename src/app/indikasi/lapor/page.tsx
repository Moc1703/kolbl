        ...
        <div className="bg-green-950/30 border border-green-900/50 rounded-sm p-8 text-center relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <button
              ...
              className="px-6 py-3 bg-amber-700 text-white font-bold uppercase tracking-widest rounded-sm hover:bg-amber-600 transition-colors"
            >
              LAPOR LAGI
            </button>
            <a
    ...
    <div className="max-w-2xl mx-auto px-4 py-6 md:py-8 font-sans">
      <div className="mb-8 border-b-2 border-neutral-800 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <a href="/indikasi" className="text-amber-500 hover:text-amber-400 text-xs font-bold uppercase tracking-widest flex items-center gap-1">
            <span>←</span> KEMBALI
          </a>
        </div>
      ...
      <form onSubmit={handleSubmit} className="bg-neutral-900 border border-neutral-800 p-6 md:p-8 space-y-8 relative rounded-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-black border border-neutral-800 rounded-sm text-white focus:outline-none focus:border-amber-500 transition-colors font-mono text-sm uppercase cursor-pointer"
                >
          ...
          <div className="space-y-5">
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-black border border-neutral-800 rounded-sm text-neutral-300 focus:outline-none focus:border-amber-500 transition-colors font-serif italic text-sm placeholder-neutral-700 leading-relaxed"
            ...
            <div>
              ...
              />
              <p className="text-[10px] uppercase tracking-widest font-mono text-neutral-600 mt-2">Masukan link GDrive/Imgur yang berisi bukti pendukung.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-xs font-mono text-neutral-600 mb-5 uppercase tracking-widest border-l-2 border-neutral-700 pl-3">Data ini dienkripsi dan hanya diakses oleh Admin untuk verifikasi.</p>
        ...
        <div className="bg-amber-950/20 border border-amber-900/50 rounded-sm p-5 hover:bg-amber-950/40 transition-colors cursor-pointer" onClick={() => setAgreedToTerms(!agreedToTerms)}>
