    ...
    <div className="max-w-2xl mx-auto px-4 py-6 md:py-8 font-sans">
      <div className="mb-8 border-b-2 border-neutral-800 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <a href="/fraud" className="text-red-700 hover:text-red-500 text-xs font-bold uppercase tracking-widest flex items-center gap-1">
            <span>←</span> KEMBALI
          </a>
        </div>
      ...
      <form onSubmit={handleSubmit} className="panel-dark p-6 md:p-8 space-y-8 relative">
        ...
        <section>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              />
              <p className="text-[10px] uppercase tracking-widest font-mono text-neutral-500 mt-2">Masukan link GDrive/Imgur yang berisi bukti pendukung pembayaran dan chat.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-xs font-mono text-neutral-500 mb-5 uppercase tracking-widest border-l-2 border-neutral-700 pl-3">Data ini dienkripsi dan hanya diakses oleh Admin untuk keperluan penyidikan internal.</p>
        ...
        <div className="bg-red-900/10 border border-red-900/50 rounded-sm p-4">
