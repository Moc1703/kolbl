  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      ...
      <div className="text-center mb-6">
        ...
        <div className="w-16 h-16 bg-gradient-to-br from-red-700 to-rose-900 rounded-2xl flex items-center justify-center mx-auto mb-4 mt-4 shadow-lg shadow-red-300">
          <span className="text-3xl">⚖️</span>
        </div>
        <h1 className="text-xl font-bold text-gray-800 mb-1">Banding Kasus Fraud</h1>
      ...
      <div className="bg-red-50 rounded-xl p-4 mb-6 border border-red-100">
        <p className="text-xs text-red-800">
          <strong>Catatan:</strong> Ajuan akan direview admin. Sertakan bukti bahwa masalah sudah diselesaikan (bukti pengembalian dana, screenshot chat klarifikasi, dll).
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 bg-gray-50"
            required
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 bg-gray-50 resize-none"
            required
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Link Google Drive / Imgur (bukti pengembalian dana, dsb)"
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 bg-gray-50"
          />
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-4 bg-gradient-to-r from-red-700 to-rose-800 text-white rounded-xl font-semibold hover:from-red-800 hover:to-rose-900 disabled:opacity-50 shadow-lg shadow-red-300 transition-all active:scale-[0.98]"
        >
